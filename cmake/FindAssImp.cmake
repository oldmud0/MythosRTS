# Try to find Assimp. Based on FindAssImp.cmake from pwn-engine
...
message(STATUS "AssImp lib dbg: ${ASSIMP_LIBRARY_DEBUG}")
message(STATUS "AssImp lib rel: ${ASSIMP_LIBRARY_RELEASE}")
